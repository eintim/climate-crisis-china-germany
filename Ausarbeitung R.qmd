...
genannt, da das Land der größte CO2-Emittent der Welt ist. 
...
genau dies versucht. In dem Tweet vergleicht er die jährlichen CO2 
Emissionen Chinas und Deutschlands.
...
beide Daten miteinander verglichen. Zwar stammen beide aus der selben Quelle, dennoch 
ist nicht garantiert, das die Daten übereinstimmen.
...
CO₂-Datensatz sind sowohl Werte mit NA und auch 0 (siehe folgenden Code-Block). Ähnliche 
Muster existieren in weiteren Spalten in beiden Datensätzen. Da diese Werte in einer 
zeitlich logischen Reihenfolge vorkommen ist davon auszugehen das bei den NA Werten 
...
Poblematisch ist, dass hier nicht die Bevölkerungsgröße einbezogen wurde. 
...
Deutschland höher ist als in China. 1965 verbauchte Deutschland 18,4-mal 
mehr Energie pro Einwohner als China. In 2021 verbauchte Deutschland pro 
Einwohner ca. 1,37-mal mehr Energie. Zwar schließt sich diese Lücke, aber 
nicht indem in Deutschland weniger Energie verbaucht wird, sondern indem China aufschließt. 
...
Energie verbaucht wird, während Chinas aggressive Wirtschaftspolitik immer einen
...
Es wurde im Gegensatz zu Detschland aber deutlich stärker in Wasserkraft 
investiert, was 
aber auch geographische Hintergründe hat. Dadurch schadet China seinen 
...
In China verliert Kohle auch an Bedeutung, trotzdem stammen noch 70% der Emissionen aus Kohle (vgl. @fig-co2_per_year_per_fossil_fuel-2). In Deutschland liegt der Anteil nur noch bei 35%. In China wird die Kohle jedoch nicht abgelöst, sondern es kommen zusätzliche Energiequellen hinzu (vgl. @fig-co2_per_year_per_fossil_fuel_china).
