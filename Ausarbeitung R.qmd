...
für die Krise zu suchen. In diesem Zusammenhang wird oft die Rolle Chinas genannt, da das Land der größte CO₂-Emittent der Welt ist. 
...
FDP-Bundestagsabgeordneter Oliver Luksic in folgendem Tweet [@FDP-Tweet] genau dies versucht. In dem Tweet vergleicht er die jährlichen CO₂-Emissionen Chinas und 
Deutschlands.
...
Daten miteinander verglichen. Zwar stammen beide aus derselben Quelle [@OWID-Github], dennoch ist nicht garantiert, das die Daten übereinstimmen.
