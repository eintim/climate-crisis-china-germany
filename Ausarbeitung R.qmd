...
Für die Visualisierung wurde zusätzlich das Paket `ggstream` [@ggstream] verwendet. Um Kartendaten zu visualisieren, wurden die Pakete `giscoR` [@giscoR] und `sf` [@sf] verwendet. Anschließend wurden die Karten mit dem Paket `gganimate` [@gganimate] animiert.
...
``` {r}
library(tidyverse)
energy <- readr::read_csv('https://raw.githubusercontent.com/owid/energy-data/master/owid-energy-data.csv', show_col_types = FALSE)
...
#| fig-cap: CO₂ Emissionen pro Einwohner in Europa im Jahr 2021
